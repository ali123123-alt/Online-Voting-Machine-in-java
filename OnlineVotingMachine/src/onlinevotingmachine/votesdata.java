 ...
 * @author Dell
 */
public class votesdata extends javax.swing.JFrame {

    /**
     * Creates new form votesdata
     */
    public votesdata() {
        initComponents();
        try {
...
//                     System.out.println(id);
                System.out.println(id + name + votes);
...
//                 JOptionPane.showMessageDialog(this, "Record Insert Successfully");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(votesdata.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
